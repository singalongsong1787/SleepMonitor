...
# 第一个卷积层
model.add(Conv2D(16, (3, 3), activation='relu', input_shape=input_shape, kernel_regularizer=l2(0.001)))
# 第一个池化层
...
for layer in model.layers:
    ...
    for weight in layer_weights:
        # 将权重展平为一维数组
        all_weights.extend(weight.flatten())

# 绘制概率密度图像
sns.kdeplot(all_weights)
plt.title('Probability Density Plot of Model Weights')
